...
vim.keymap.set("n", "<F6>", ':CMakeRun')
vim.keymap.set("n", "<F4>", ':CMakeBuild<CR>')
...
vim.keymap.set("n", "<Leader>dk", ':lua require"dap".step_into()<CR>')
vim.keymap.set("n", "<Leader>dl", ':lua require"dap".step_out()<CR>')

-- buffer management harpoon2
